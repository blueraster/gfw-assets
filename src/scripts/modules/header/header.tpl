<div class="wrapper">
  <div class="m-header">
    <div class="m-header-scroll">
      ...
      <!-- APPS -->
      <div id="submenuApps" class="m-apps -active">
        <div class="m-apps-content">
          <div class="apps">
            ...
            <ul>
              ...
              <li class="shape-all-apps">
                <a href="/explore">
                  <div class="app">
                    <svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-h-all-apps"></use></svg>
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li><a href="/stayinformed/newsletter">Newsletter</a></li>
