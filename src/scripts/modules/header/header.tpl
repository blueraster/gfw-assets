<div class="wrapper">
  <div class="m-header">
    <ul class="m-header-nav -primary">
      <li class="m-header-item -default shape-home">
        <a id="btnSubmenuHome" data-submenu="#submenuHome" class="m-header-submenu-btn" href="/">
          ...
          <svg style="display: none;"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-h-close"></use></svg>
          <span>Home</span>
        </a>
        <!-- HOME SUBMENU -->
    ...
    <ul class="m-header-nav -secondary">
      ...
      <li class="m-header-item -text shape-odp"><a class="external-link" href="http://data.globalforestwatch.org/" target="_blank"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-h-odp" target="_blank"></use></svg><span>Open Data Portal</span></a></li>
      <li class="m-header-item -text shape-mygfw" id="my-gfw-container"></li>
      <li class="m-header-item -search">
      ...
      <li class="m-header-item -translate"><div id="googleTranslate"></div></li>
    </ul>
    <ul class="m-header-nav -mobile">
      <li class="m-header-item -default shape-menu">
        ...
        <!-- HOME SUBMENU -->
        <div id="submenuMenuMobile" class="m-header-submenu -scroll-bar -home -menu">
          <script type="text/html" id="item_tmpl">
            <% for ( var i = 0; i < members.length; i++ ) { %>
              <li id="<%=members[i].id%>" class="<%=(i % 2 == 1 ? " even" : " odd")%>">
                <%=i+1%>人目 <%=members[i].text%> (from <%=members[i].name%>[ID:<%=members[i].id%>])
              </li>
            <% } %>
          </script>
...
<script id="my-gfw-menu-modal-template" type="text/x-template">
  <div class="my-gfw-modal-backdrop"></div>
...
<script id="my-gfw-menu-loggedout-template" type="text/x-template">
  <a href="#" id="my-gfw-open-modal">
    <svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-h-mygfw"></use></svg>
    <span>Log in to My GFW</span>
  </a>
...
<script id="my-gfw-menu-loggedin-template" type="text/x-template">
  <a href="/my_gfw" class="my-gfw-loggedin">
    <svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-h-mygfw"></use></svg>
    <span>My GFW</span>
  </a>
  <ul class="submenu">
