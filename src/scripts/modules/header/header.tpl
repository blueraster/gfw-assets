  ...
  <div class="m-header">
    <ul class="m-header-nav -primary">
      ...
      <li class="m-header-item -default -only-desktop shape-howto">
        <a class="link-analytics" title="How to" target="_blank" href="/howto">
          <div class="-svg">
      ...
      <li class="m-header-item -default shape-more">
        ...
        <!-- <div id="submenuMore" class="m-header-submenu -more -default -right">
          <ul class="more-list">
            ...
            <li class="shape-howto"><a class="link-analytics" target="_blank" href="/howto"><span>How to</span></a></li>
