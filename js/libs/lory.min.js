/*v2.0.1*/
var _lory=window.lory?(window.lory.lory||window.lory):null;
...
// Lory no Conflict
window.lory.noConflict=function(){var a=window.lory.lory||window.lory;return _lory&&(window.lory=_lory),a};
